...
public class PageController2 {
	...
	{// 初始化代码块
		if(PageController2.bigList==null) {
			PageController2.bigList=DataOperate.getSelectAll2("select * from pro");// 调用查询数据库的方法，返回所有的行
		}
		//获取总页数
	...
	public PageController2() {}//无参构造方法
	
	public PageController2(String sql) {//执行sql语句
		PageController2.bigList=DataOperate.getSelectAll2(sql);
	}
	...
	public PageController2(int curentPageIndex) {//构造方法设置当前页
