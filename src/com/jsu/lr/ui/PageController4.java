...
public class PageController4 {
	...
	{// 初始化代码块
		if(PageController4.bigList==null) {
			PageController4.bigList=DataOperate.getSelectAll4("select * from order01");// 调用查询数据库的方法，返回所有的行
		}
		//获取总页数
	...
	public PageController4() {}//无参构造方法
	
	public PageController4(String sql) {//执行sql语句
	...
	public PageController4(int curentPageIndex) {//构造方法设置当前页
